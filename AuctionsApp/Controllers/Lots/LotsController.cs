using Auctions.Application.Lots.Create;
using Auctions.Application.Lots.Delete;
using Auctions.Application.Lots.GetLotsByAuctionId;
using Auctions.Application.Lots.Update;
using MediatR;
using Microsoft.AspNetCore.Http;
using Microsoft.AspNetCore.Mvc;

namespace AuctionsApp.Controllers.Lots
{
    /// <summary>
