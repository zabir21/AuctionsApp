...
using MediatR;
using Auctions.Application.Auctions.Create;
using Microsoft.VisualBasic.FileIO;
using FluentResults;
using Auctions.Application.Auctions.Cancel;
using Auctions.Application.Auctions.ChangeCreationState;
using Auctions.Application.Auctions.Delete;
using Auctions.Application.Auctions.Get;
using Auctions.Application.Auctions.Update;
using AuctionsApp.Controllers.Auction.Dto;

namespace AuctionsApp.Controllers.Auction
{
    /// <summary>
